...
class _RegisterScreenState extends State<RegisterScreen> {
  // Clave del formulario para futuras validaciones
  ...
  // Gestión de estado local para los iconos de visibilidad y el checkbox
  ...
  Widget build(BuildContext context) {
    // Definimos el color principal basado en tu diseño
    const primaryBlue = Color(0xFF5D9CFF);
    const backgroundColor = Color(0xFFF4F8FF); // Fondo azul muy claro
                        ...
                        SizedBox(
                          ...
                          child: FilledButton(
                            onPressed: _acceptedTerms
                                ? () {}
                                : null, // Deshabilitado si no acepta términos
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: isPassword
            ...
            : null,
        filled: true,
        fillColor: const Color(0xFFF9FAFC), // Color de fondo del input
